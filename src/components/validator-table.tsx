  ...
  return (
    <div className="bg-cream-5 border border-cream-8 rounded-2xl p-6 mb-8 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.32s' }}>
      ...
      <div className="relative mb-[18px]">
        <svg aria-hidden="true" className="absolute top-1/2 left-[14px] -translate-y-1/2 w-4 h-4 text-cream-40 pointer-events-none" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
